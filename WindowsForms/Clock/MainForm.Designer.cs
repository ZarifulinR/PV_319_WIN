namespace Clock
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmFonys = new System.Windows.Forms.ToolStripMenuItem();
			...
			// cmFonys
			// 
			this.cmFonys.CheckOnClick = true;
			this.cmFonys.Name = "cmFonys";
			this.cmFonys.Size = new System.Drawing.Size(210, 24);
			this.cmFonys.Text = "Fonts";
			this.cmFonys.Click += new System.EventHandler(this.cmFonys_Click);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem cmFonys;
